...
export const InstructorsCard = () => {
  return (
    <div className="w-full xl:h-104 flex flex-col-reverse flex-wrap rounded-xl shadow-lg relative overflow-hidden">
        <div className=" w-80 xl:my-12 my-6 xl:ml-9  ml-4 z-10">
        ...
        <div className="xl:absolute xl:bottom-0 xl:right-0 xl:min-w-max w-80 ml-4 my-10 mask">
