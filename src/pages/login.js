	...
	return (
		<>
			...
			<section className="max-w-screen-xl mx-auto my-52">
                ...
                <form>
                    <div className="xl:w-96 xl:h-16 xl:text-l xl:px-10 mx-auto flex items-center font-mabry border-2 border-black rounded-full">
                    ...
                    <button type='submit' className='xl:text-l xl:py-3 xl:px-7 xl:w-96 mx-auto px-3 text-m flex justify-between items-center font-mabry bg-yellow rounded-full'>
                        ВОЙТИ
