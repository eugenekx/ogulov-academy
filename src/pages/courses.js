        ...
        <>
            <section className="xl:mx-auto max-w-screen-xl">
                <div className="flex">
                    ...
                    <button className='xl:text-xl xl:py-3 xl:px-7 xl:w-96 my-auto px-3 text-md flex justify-between items-center font-mabry bg-yellow rounded-full'>
                        СКАЧАТЬ КАЛЕНДАРЬ
                        <div className='xl:scale-100 scale-75'><Arrow /></div>
                    </button>
                </div>
                <div className="flex gap-6">
                    <div className="grow xl:h-16 xl:text-xl xl:pl-10 xl:pr-4 flex justify-between items-center font-mabry border-2 border-black rounded-full">
                ...
                <div className="xl:h-16 xl:text-xl xl:my-10 xl:pl-10 xl:pr-4 flex justify-between items-center font-mabry border-2 border-black rounded-full">
