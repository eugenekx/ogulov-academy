...
export default function Document() {
	return (
		<Html lang="en">
			...
			<meta
				property="og:url"
				content="https://ogulov-academy.vercel.app/"
			/>
			<meta property="og:type" content="website" />
			<meta
				property="og:title"
				content="Учебно-оздоровительный Огулов Центр"
			/>
			<meta
			...
			<meta
				property="og:image"
				content="https://ogulov-academy.vercel.app/og.png"
			/>

			<meta name="twitter:card" content="summary_large_image" />
			<meta
				property="twitter:domain"
				content="ogulov-academy.vercel.app"
			/>
			<meta
